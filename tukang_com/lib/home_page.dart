  ...
  child: Column(
    ...
    children: [
      ...
      Row(
        ...
        children: [
          Icon(Icons.payment), // Ikon di sini
          ...
          IconButton(
            onPressed: () {},
            icon: Icon(Icons.check_circle), // Ganti ikon di sin
          )                    
                        ]
                        ),
                        SizedBox(
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                  ...
                                  child:
                                      Image.asset('PTNippon.png', scale: 1)),
                              SizedBox(
                                width: 20,
                              ),
                              Container(
                                  ...
                                  child:
                                      Image.asset('PTInka.jpg', scale: 1)),
                              SizedBox(
                                width: 20,
                              ),
                              Container(
                              ...
                              Container(
                                  ...
                                  child:
                                      Image.asset('PTWaskita.jpg', scale: 1)),
                            ],
                          ),
                        )
                      ],
                          ...
                          child: Row(
                            children: [
                              ...
                              Container(
                                  ...
                                  child:
                                      Image.asset('BankBRI.png', scale: 1)),
                              SizedBox(
                                width: 20,
                              ),
                              Container(
                                  ...
                                  child:
                                      Image.asset('BankBNI.png', scale: 1)),
                              SizedBox(
                                width: 20,
                              ),
                              Container(
                              ...
                              Container(
                                  ...
                                  child:
                                      Image.asset('mandiri.jpg', scale: 1)),
                            ],
                          ),
                        )
                      ],
